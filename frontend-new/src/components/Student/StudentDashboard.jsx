...
const StudentDashboard = () => {
    ...
    return (
        <div className="p-6 space-y-10 min-h-screen bg-[#050510] text-gray-100">
            {/* Header */}
            <header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* 1. PROFILE CARD */}
                <div className="lg:col-span-1 bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-3xl shadow-2xl">
                ...
                {/* 2. CLASS NOTES (The part you requested) */}
                <div className="lg:col-span-2 bg-white/5 backdrop-blur-xl border border-purple-500/20 p-6 rounded-3xl shadow-2xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {data.notes.length > 0 ? data.notes.map((note) => (
                            <div key={note._id} className="bg-black/40 p-5 rounded-2xl border border-white/5 hover:border-purple-500/50 transition-all group">
                ...
                {/* 3. TEST RESULTS */}
                <div className="lg:col-span-2 bg-white/5 backdrop-blur-xl border border-emerald-500/20 p-6 rounded-3xl shadow-2xl">
                ...
                {/* 4. FEE STATUS */}
                <div className="lg:col-span-1 bg-white/5 backdrop-blur-xl border border-yellow-500/20 p-6 rounded-3xl shadow-2xl">
                    <h3 className="text-xl font-bold text-yellow-400 mb-6">Fees Status</h3>
                    {data.fees?.fees?.length > 0 ? (
                        <div className="space-y-4">
                            {data.fees.fees.map((fee, idx) => (
                                <div key={idx} className="flex justify-between items-center bg-black/40 p-4 rounded-2xl">
