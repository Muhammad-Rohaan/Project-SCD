...
import { deleteTeacherById, fetchAllTeachers, fetchTeachersByClass, registerReceptionist, registerTeacher, removeReceptionist, searchTeacherByClassAndSubject, updateTeacher } from '../controllers/admin.controller.js';
...
router.delete('/az-reception/remove-receptionist/:receptionRegId', removeReceptionist);
